...
namespace Rezervari_Hotel
{
    public partial class Form3 : Form
    {
        ...
        public Form3(string nume, string prenume, int varsta, string domiciliu)
        {
            ...
            //foreach (string destinatie in listaDeDestinatii)
            //{
            //    destinatiiComboBox.Items.Add(destinatie);
            //}
        ...
        private void salveazaButton_Click(object sender, System.EventArgs e)
        {
            ...
            //MessageBox.Show($"Rezervare: {rezervare.Destinatie}, {rezervare.Zile} zile, de la {rezervare.dataSosire.ToShortDateString()} până la {rezervare.dataPlecare.ToShortDateString()}");
